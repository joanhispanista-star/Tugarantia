...
/* El banco que abre play/ de verdad. Es el mismo de vitrina.test.js, reducido a
   lo que hace falta acá: la página corre entera en un contexto de mentira y se
   le pueden pedir cosas con P.ev(). Vive acá y no importado porque vitrina lo
   declara dentro de su describe; duplicarlo es peor que compartirlo, pero
   compartir un banco a medio armar entre dos archivos es peor todavía. */
function abrirPlay() {
